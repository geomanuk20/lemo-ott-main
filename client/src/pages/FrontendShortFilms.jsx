 ...
 return (
  <FrontendLayout isTransparent={true}>
   ...
   <div className="fe-hero-wrapper-v">
    <section className="fe-movies-hero">
     ...
     <div className="hero-content">
      <h1>Short Films<span style={{ color: '#b3d332' }}>.</span></h1>
      <p>Explore outstanding stories, creative concepts, and award-winning short films here to watch fixed</p>
     </div>
    </section>
   </div>
        ...
        return (
         <Link to={`/details/movie/${movie._id}`} key={movie._id} className="fe-movie-card-new">
          ...
          <div className="card-info-new">
           ...
           <span className="genre-text-red">{movie.genres?.[0] || 'Drama'}</span>
   ...
   <style dangerouslySetInnerHTML={{ __html: `
    ...
    .fe-movies-hero { position: absolute; top: 0; left: 0; width: 100%; height: 100%; min-height: 350px; background: url('https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=1920&q=80') center/cover; background-attachment: scroll; display: flex; align-items: center; padding: 0 10%; color: #fff; z-index: 1; overflow: hidden; cursor: pointer; }
...
export default FrontendShortFilms;
