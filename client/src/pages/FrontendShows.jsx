 ...
 useEffect(() => {
  try {
   ...
   if (cached) {
    ...
    if (settings.shows?.toUpperCase() === 'OFF') {
     navigate('/', { replace: true });
     return;
    }
   }
  } catch (err) {
   console.error('Error parsing menu settings in shows page:', err);
  }
 ...
 return (
  <FrontendLayout isTransparent={true}>
   ...
   <style dangerouslySetInnerHTML={{ __html: `
    ...
    .fe-movies-hero { position: absolute; top: 0; left: 0; width: 100%; height: 100%; min-height: 350px; background: url('https://images.unsplash.com/photo-1593784991095-a205069470b6?w=1920&q=80') center/cover; background-attachment: scroll; display: flex; align-items: center; padding: 0 10%; color: #fff; z-index: 1; overflow: hidden; cursor: pointer; }
    ...
    @media (max-width: 768px) { 
     .fe-movies-hero { position: relative; height: auto; min-height: 220px; background-attachment: scroll; padding: 80px 20px 40px; background-image: url('https://images.unsplash.com/photo-1593784991095-a205069470b6?w=800&q=80'); }
