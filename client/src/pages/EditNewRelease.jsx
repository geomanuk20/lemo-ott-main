...
const EditNewRelease = () => {
   ...
   try {
    ...
    if (movieRes.ok) {
     ...
     setFormData({
      ...
      actors: Array.isArray(movie.actors) ? [...new Set(movie.actors.map(a => typeof a === 'object' ? a._id : a))] : [],
      directors: Array.isArray(movie.directors) ? [...new Set(movie.directors.map(d => typeof d === 'object' ? d._id : d))] : [],
 ...
 const handleSave = async (e) => {
  ...
  try {
   ...
   const response = await fetch(`/api/new-releases/${id}`, {
    method: 'PUT',
