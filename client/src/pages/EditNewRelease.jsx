   ...
   try {
    ...
    if (movieRes.ok) {
     ...
     setFormData({
      ...
      actors: Array.isArray(movie.actors) ? movie.actors.map(a => typeof a === 'object' ? a._id : a) : [],
      directors: Array.isArray(movie.directors) ? movie.directors.map(d => typeof d === 'object' ? d._id : d) : [],
