...
const EditEpisode = () => {
 ...
 if (initialLoading) return <div style={{color: '#fff', padding: '50px', textAlign: 'center'}}>Loading Episode Data...</div>;
 ...
 return (
  <div className="add-episode-page">
   ...
   <div className="imdb-import-section">
    ...
    <p className="imdb-note">Modify the details below and click save to update the episode.</p>
   </div>
    ...
    <div className="form-grid">
     ...
     <div className="form-column">
      ...
      <div className="form-group">
       ...
       {formData.poster && (
        <div className="poster-preview mt-10" style={{ marginTop: '10px' }}>
      ...
      <div className="form-actions">
       <button type="submit" className="save-btn" disabled={loading}>
        <Save size={20} />
        <span>{loading ? 'Updating...' : 'Update Episode'}</span>
       </button>
      </div>
     </div>
    </div>
   ...
   <style dangerouslySetInnerHTML={{ __html: `
    ...
    .radio-item { display: flex; align-items: center; gap: 10px; cursor: pointer; font-size: 1.1rem; font-weight: 700; position: relative; color: #fff; }
