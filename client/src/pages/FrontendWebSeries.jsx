 ...
 return (
  <FrontendLayout isTransparent={true}>
   ...
   <style dangerouslySetInnerHTML={{ __html: `
    ...
    .fe-movies-hero { position: absolute; top: 0; left: 0; width: 100%; height: 100%; min-height: 350px; background: url('https://images.unsplash.com/photo-1626814026160-2237a95fc5a0?w=1920&q=80') center/cover; background-attachment: scroll; display: flex; align-items: center; padding: 0 10%; color: #fff; z-index: 1; overflow: hidden; cursor: pointer; }
    ...
    @media (max-width: 768px) { 
     .fe-movies-hero { position: relative; height: auto; min-height: 220px; background-attachment: scroll; padding: 80px 20px 40px; background-image: url('https://images.unsplash.com/photo-1626814026160-2237a95fc5a0?w=800&q=80'); }
